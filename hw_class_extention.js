...
продуктов заказа.
Метод getTotalPrice() - возвращает общую стоимость заказа, основанную на ценах 
продуктов.
...
class Order {
    ...
    getTotalPrice() {
        return this.products.reduce((sum, item) => item.price + sum, 0)
    }
}
